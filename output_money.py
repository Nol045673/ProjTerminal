...
class Snyat(object):
    def setupUi(self, MainWindow):
        ...
        self.input_chet = QtWidgets.QLineEdit(self.centralwidget)
        self.input_chet.setGeometry(QtCore.QRect(150, 280, 491, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.input_chet.setFont(font)
        self.input_chet.setStyleSheet("background-color: #22222e;\n"
                                      "border: 2px solid #f66867;\n"
                                      "border-radius: 30;\n"
                                      "color: white")
        self.input_chet.setText("")
        self.input_chet.setAlignment(QtCore.Qt.AlignCenter)
        self.input_chet.setObjectName("input_correct_valut")
        self.input_value = QtWidgets.QLineEdit(self.centralwidget)
        self.input_value.setGeometry(QtCore.QRect(150, 390, 491, 51))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.input_value.setFont(font)
        self.input_value.setStyleSheet("background-color: #22222e;\n"
                                       "border: 2px solid #f66867;\n"
                                       "border-radius: 30;\n"
                                       "color: white;")
        self.input_value.setText("")
        self.input_value.setAlignment(QtCore.Qt.AlignCenter)
        self.input_value.setObjectName("input_correct_value")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Снятие наличных"))
        self.pushButton.setText(_translate("MainWindow", "Снять"))
